...
namespace DrillingProperties
{
    public class TestClass
    {
        ...
        [SemanticFact("BitDepth#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.DepthDrilling)]
        ...
        [SemanticFact("TopOfStringVelocityUpward#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.BlockVelocityDrilling)]
        ...
        [SemanticFact("EstimatedBitDepth#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.DepthDrilling)]
        [SemanticFact("WGS84VerticalDatum", Nouns.Enum.WGS84VerticalLocation)]
        [SemanticFact("VerticalDepthFrame", Nouns.Enum.VerticalDepthFrame)]
        [SemanticFact("VerticalDepthFrame", Verbs.Enum.HasReferenceFrameOrigin, "WGS84VerticalDatum")]
