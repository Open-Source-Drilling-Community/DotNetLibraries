...
namespace OSDC.DotnetLibraries.Drilling.DrillingProperties
{
    ...
    public class OptionalExcludeFactAttribute: OptionalFactAttribute
    {
        ...
        public OptionalExcludeFactAttribute(byte bundleIdx, string subject, Verbs.Enum verb, BasePhysicalQuantity.QuantityEnum quantity, params string[] objectAttributes) : base(bundleIdx, subject, verb,quantity, objectAttributes)
        {
        }
        ...
        public OptionalExcludeFactAttribute(byte parentBundleIdx, byte bundleIdx, string subject, Verbs.Enum verb, BasePhysicalQuantity.QuantityEnum quantity, params string[] objectAttributes) : base(bundleIdx, subject, verb, quantity, objectAttributes)
        {
        }
