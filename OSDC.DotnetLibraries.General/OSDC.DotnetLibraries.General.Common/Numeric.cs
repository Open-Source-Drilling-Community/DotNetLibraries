...
namespace OSDC.DotnetLibraries.General.Common
{
    public class Numeric
    {
        ...
        /// <summary>
        /// definition of ratio of circumference of circle to diameter.
        /// </summary>
        ...
        {
            return LT(d1, d2, DOUBLE_ACCURACY);
        }
        ...
        {
            return LE(d1, d2, DOUBLE_ACCURACY);
        }
        ...
        {
            return GT(d1, d2, DOUBLE_ACCURACY);
        }
        ...
        {
            return GE(d1, d2, DOUBLE_ACCURACY);
        }
        ...
        {
            return EQ(d1, d2, DOUBLE_ACCURACY);
        }
