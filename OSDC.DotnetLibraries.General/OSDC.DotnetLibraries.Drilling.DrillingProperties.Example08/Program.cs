...
namespace DrillingProperties
{
    ...
    public class MeasuredFluidDensity
    {
        ...
        [SemanticFact("temperature#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.TemperatureDrilling)]
        [SemanticFact("MovingAverage", Nouns.Enum.MovingAverage)]
        ...
        [SemanticFact("pressure#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.PressureDrilling)]
