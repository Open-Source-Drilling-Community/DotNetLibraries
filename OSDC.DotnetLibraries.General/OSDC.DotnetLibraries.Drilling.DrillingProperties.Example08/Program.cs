...
namespace DrillingProperties
{
    ...
    public class MeasuredFluidDensity
    {
        ...
        [SemanticFact("temperature#01", Verbs.Enum.IsOfMeasurableQuantity, DrillingPhysicalQuantity.QuantityEnum.DrillingTemperature)]
        [SemanticFact("MovingAverage", Nouns.Enum.MovingAverage)]
        ...
        [SemanticFact("pressure#01", Verbs.Enum.IsOfMeasurableQuantity, DrillingPhysicalQuantity.QuantityEnum.DrillingPressure)]
