...
namespace DrillingProperties
{
    public class TestClass
    {
        ...
        [SemanticFact("FluidDensitySetPoint#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.MassDensityDrilling)]
        ...
        [SemanticFact("FluidDensityUniform#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.MassDensityDrilling)]
        ...
        [SemanticFact("FluidDensityEstimated#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.MassDensityDrilling)]
        ...
        [SemanticFact("FluidDensityMeasured#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.MassDensityDrilling)]
        ...
        [SemanticFact("CuttingsDensityMeasured#01", Verbs.Enum.IsOfMeasurableQuantity, PhysicalQuantity.QuantityEnum.MassDensityDrilling)]
        [SemanticFact("tos#01", Nouns.Enum.TopOfStringReferenceLocation)]
